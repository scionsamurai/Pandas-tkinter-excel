...
if __name__ == '__main__':
   ...
   root.bind('<Return>', (lambda event, e=ents: inp.row_frames(e, ents2, li, auto_open_box, 'csv')))
   ...
   #b5 = Button(root, text='Open File(s)',
   #            command=(lambda e=root: answer.extend(intro_dialog(e))))
